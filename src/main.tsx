        ...
        <>
          <TimelineContainer id="mainId">
            ...
            <div className={"lifetime3 "+lifetimeDivClass[2]}><h3>Graduação, mestrado e doutorado em matemática de 2010 a 2021</h3>
                ...
                <p>Cursei <a href="historicoIFC.pdf" target="_blank">Licenciatura em Matemática no Instituto Federal Catarinense (IFC- Campus Rio do Sul)</a> e, durante o curso, fiz alguns pequenos projetos em programação para serem usados na sala de aula.</p>
                <div className='projectLinks'>
                        [ Futuramente, adicionarei alguns dos meus projetos antigos aqui ]
                </div>                
                <p>Esse novo contato com matemática me fez decidir me aprofundar mais no conhecimento científico-matemático. Terminando a licenciatura, fiz <a href="historicoUFAL_mestrado.pdf" target="_blank">mestrado na Universidade Federal de Alagoas</a> na área de matemática pura, subárea de álgebra, especificamente, representações de álgebras.</p>
                <p>Terminando o mestrado, iniciei o meu <a href="historicoUSP.pdf" target="_blank">doutorado na USP</a>, também na subárea de representações algébricas.</p>
